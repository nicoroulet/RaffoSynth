...
;versión con 1/4 de accesos a memoria, prev en registro, con loop. A grandes razgos, la mas eficiente
equalizer:
	push rbp
	mov rbp, rsp
	push rbx		;rbx es i
...
;versión con un dato a la vez
equalizerCuatroAccesos:
	push rbp
	mov rbp, rsp
	push rbx		;rbx es i
	push r12		;r12 es aux
...
;versión con un dato a la vez, sumas verticales
equalizerSumasVerticales:
	...
	pand xmm8, xmm10	; filtro todo lo que no sea el primer float
	;-----------------
	;movdqu xmm14, xmm10	; xmm14 tiene un dw de unos, el resto 0
